$(document).ready(function() {
  ...
  $('#id_username').attr('placeholder', 'Ej: gfigueroa, jocampo, aovalle');
  $('#id_first_name').attr('placeholder', 'Ej: Genesis, Jennifer, Alfredo');
  $('#id_last_name').attr('placeholder', 'Ej: Figueroa, Ocampo, Ovalle');
  $('#id_email').attr('placeholder', 'Ej: ge.figueroa@gmail.com');
  $('#id_rut').attr('placeholder', 'Ej: 12345678-9 (sin puntos y con guión)');
